...
def file():
    ...
    filename = filedialog.askopenfilename(initialdir="/", title="Select An Image or Mp4 Video",filetypes=(("jpg files", "*.jpg"),("png files", "*.png"),("jpeg files", "*.jpeg"),("mp4 videos","*.mp4")))
    if(filename is ''):
        return
